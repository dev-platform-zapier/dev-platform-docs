...
This doc describes the latest CLI version (**15.18.0**), as of this writing. If you're using an older version of the CLI, you may want to check out these historical releases:
...
Ensure you're handling errors correctly for your platform version. The latest released version is **15.18.0**.
...
The most recently released version of `cli` and `core` is **15.18.0**. You can see the versions you're working with by running `zapier -v`.
