---
title: Platform CLI
description: "Zapier is a platform for creating integrations and workflows. This CLI is your gateway to creating custom applications on the Zapier platform."
---

[![npm version](/images/zapier-platform-cli.svg)](https://www.npmjs.com/package/zapier-platform-cli)
...
<CardGroup cols={3}> <Card title="CLI Reference" icon="book-open" href="https://github.com/zapier/zapier-platform/blob/main/packages/cli/docs/cli.md" horizontal/> <Card title="Schema Reference" icon="code" href="https://github.com/zapier/zapier-platform/blob/main/packages/schema/docs/build/schema.md" horizontal/> </CardGroup>
...
- [Getting Started](#getting-started)
  ...
  - [Tutorial](#tutorial)
- [Creating a Local Integration](#creating-a-local-integration)
  - [Local Project Structure](#local-project-structure)
  - [Local App Definition](#local-app-definition)
  - [Zapier Platform Schema](#zapier-platform-schema)
- [Registering an Integration](#registering-an-integration)
- [Converting an Existing Integration](#converting-an-existing-integration)
...
- [Deploying an Integration Version](#deploying-an-integration-version)
  - [Private Integration Version (default)](#private-integration-version-default)
  - [Sharing an Integration Version](#sharing-an-integration-version)
  - [Promoting an Integration Version](#promoting-an-integration-version)
...
- [FAQs](#faqs)
  ...
  - [How do I manually set the Node.js version to run my integration with?](#how-do-i-manually-set-the-nodejs-version-to-run-my-integration-with)
...
> We previously used the term "app", but Zapier now uses "integration". In some docs or code, you might still see "app", but in most cases, the two terms are interchangeable. Both refer to your code that connects your API with Zapier.
...
[Zapier Platform UI](https://developer.zapier.com/) is designed to quickly spin up new integrations, and collaborate on them with teams that include non-developers. It's the quickest way to start using the Zapier platform—and you can manage your CLI integration' core details from its online UI as well. You can also [export](https://platform.zapier.com/manage/export-cli) Zapier Platform UI integrations to CLI to start development in your browser, then finish out the core features in your local development environment.
...
When a user authenticates to your integration through Zapier, a "connection" is created representing their authentication details. Data tied to a specific authentication connection is included in the [bundle object](#bundle-object) under `bundle.authData`.
...
Broadly speaking, all releases will continue to work indefinitely. While you never _have_ to upgrade your integration's `zapier-platform-core` dependency, we recommend keeping an eye on the [changelog](https://github.com/zapier/zapier-platform/blob/main/CHANGELOG.md) to see what new features and bug fixes are available.
