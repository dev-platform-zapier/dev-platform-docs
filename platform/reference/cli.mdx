...
description: These are the generated docs for all Zapier platform CLI commands.
---
...
[Previous: Zapier Platform CLI docs](/platform/reference/cli-docs) [Next: Transfer](/platform/reference/transfer)
