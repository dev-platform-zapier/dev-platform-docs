...
description: "After your integration has entered the beta or public status, you can set a new default version for public use. This process is called promoting a version."
---
...
4.  On the version you want to promote, click the **three dots icon**
 <Frame>
  <img src="/images/2ee11c82946187818a9622c4b4bf65bc.png"/>
</Frame>
 and **Promote**.
...
> **Note**: If you have a private integration, you will not see the _Promote_ option. Instead, you can [share your new version](/platform/manage/sharing) with users.
