...
description: Reference for `zapier-platform-core`
---
...
| `timezone`                     | null         | The timezone the user has configured for their account or specfic automation. Received as [TZ identifier](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones), such as "America/New_York".                                                                                                                                                                                                                                       |
