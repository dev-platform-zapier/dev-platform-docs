...
[![NPM Version](https://img.shields.io/npm/v/zapier-platform-cli)](https://www.npmjs.com/package/zapier-platform-cli)
...
<CardGroup cols={3}>
  <Card title="CLI Reference" icon="book-open" href="https://github.com/zapier/zapier-platform/blob/main/packages/cli/docs/cli.md" horizontal />

  <Card title="Schema Reference" icon="code" href="https://github.com/zapier/zapier-platform/blob/main/packages/schema/docs/build/schema.md" horizontal />
</CardGroup>
...
* `Error` (*added in v9.3.0*) - Stops the current operation, allowing for (auto) replay. Read more on [General Errors](#general-errors)
...
* `ThrottledError` (*new in v11.2.0*) - Tells Zapier to retry the current operation after a delay specified in seconds. Read more on [Handling Throttled Requests](#handling-throttled-requests)
...
You can get help by either emailing [`partners@zapier.com`](mailto:partners@zapier.com) or by [joining our developer community here](https://community.zapier.com/developer-discussion-13).
